 ...
 */
/*
Tx of BT -> Rx of Ard (PIN 0)
Rx of BT -> Tx of Ard (PIN 1) Via level Shifter 
Don't forget to connect bluetooth and start Tx of atlest one sensor
*/
/*
Tx of BT -> Rx of Ard (PIN 10)
Rx of BT -> Tx of Ard (PIN 11) Via level Shifter 
Don't forget to connect bluetooth and start Tx of atlest one sensor
 */
...
void loop()
{
  ...
  {
    //Serial.println("No start cmd char");
